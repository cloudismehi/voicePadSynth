...
### _as of right now_
i have the basic audio framework worked out, and i made a sine oscillator voice that accepts polyphony, the voices are currently set up to 200Hz by default. 
